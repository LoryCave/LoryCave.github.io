...
$sitename='Farming Simulator 22 Mods';
...
<title><?php print$current_dir_name==''?'Farming Simulator 22 Mods':$current_dir_name?></title>
<style type="text/css">
body { font-family: tahoma, verdana, arial; font-size: 0.7em; color: black; padding-top: 8px; cursor: default; background-color: #fff; }
#idx { border: 3px solid #fff; width: 800px; }
...
function _head()
{
	...
	idx.innerHTML='<div class="rounded gray" style="padding:5px 10px 5px 7px;color:#202020">' +
		'<p class="left">' +
			'<strong><?php print$current_dir_name==''?$sitename:$current_dir_name?></strong><?php print$dir!=''?'&nbsp; (<a href="'.$up_url.'">Back</a>)':''?><br />' + (_files.length+_dirs.length) + ' file in questa cartella, ' + _s(_tsize) + ' totali.' +
		'</p>' +
		'<p class="right">' +
			'Ordina per: <span class="link" onmousedown="return _srt(\'name\');" id="sort_name">Nome</span>, <span class="link" onmousedown="return _srt(\'type\');" id="sort_type">Tipo</span>, <span class="link" onmousedown="return _srt(\'size\');" id="sort_size">Dimensione</span>, <span class="link" onmousedown="return _srt(\'date\');" id="sort_date">Data</span>' +
		'</p>' +
...
function _tbl()
{
	...
	if(_tpg>1)html+='<p style="padding:5px 5px 0px 7px;color:#202020;text-align:right;"><span class="link" onmousedown="_pp();return false;">Precedente</span> ('+_cpg+'/'+_tpg+') <span class="link" onmousedown="_np();return false;">Successiva</span></p>';
